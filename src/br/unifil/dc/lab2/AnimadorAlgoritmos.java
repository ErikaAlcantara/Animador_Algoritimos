...
public class AnimadorAlgoritmos extends JFrame {
    ...
    public void onBtnCarregarPressionado() {
        ...
        switch (algoritmo) {
            ...
            case CLASSIFICADOR_MERGESORT:
                novoFilme = AlgoritmosAnimados.classificarPorMergeSort(valores);
                break;

            case CLASSIFICADOR_QUICKSORT:
                novoFilme = AlgoritmosAnimados.classificarPorQuickSort(valores, 0, valores.size() - 1);
                break;
